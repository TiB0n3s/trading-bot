...
def _classify_base(snapshot: dict[str, Any]) -> SetupResult:
    ...
    if trend_bucket == "neutral/weak" and vwap_bucket == "near_vwap" and rs_bucket == "weak":
        return SetupResult(
    ...
    if trend_bucket == "neutral/weak" and vwap_bucket == "above_vwap" and rs_bucket == "neutral":
        return SetupResult(
    ...
    if trend_bucket == "neutral/weak" and vwap_bucket == "far_below_vwap" and rs_bucket == "weak":
        return SetupResult(
    ...
    if trend_bucket == "neutral/weak" and vwap_bucket == "above_vwap" and rs_bucket == "strong":
        return SetupResult(
    ...
    if trend_bucket == "neutral/weak" and vwap_bucket == "below_vwap" and rs_bucket == "weak":
        return SetupResult(
    ...
    if trend_bucket == "neutral/weak" and vwap_bucket == "near_vwap" and rs_bucket == "neutral":
        return SetupResult(
    ...
    if trend_bucket == "bullish/confirmed" and vwap_bucket == "near_vwap" and rs_bucket == "strong":
        return SetupResult(
    ...
    if trend_bucket == "neutral/weak" and vwap_bucket == "below_vwap" and rs_bucket == "neutral":
        return SetupResult(
...
def build_default_setup_engine_service(db_path=None) -> SetupEngineService:
    repository = (
        SetupEngineRepository(db_path=db_path) if db_path is not None else SetupEngineRepository()
    )
