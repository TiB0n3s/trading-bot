...
def main():
    ...
    print(f"  policy recommendation       : {policy.get('recommendation')} - {policy.get('reason')}")
    print(f"  replacement recommendation  : {replacement.get('recommendation')} - {replacement.get('reason')}")
