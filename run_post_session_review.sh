...
"${PYTHON}" pipeline/retrain.py --date "${TODAY}" --sessions 5 --bad-session-limit 3 || echo "WARN: automated retraining trigger did not complete; review pipeline/retrain.py output"
