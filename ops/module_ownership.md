...
| Composition | `services/container.py`, `app.py`, `src/trading_bot/web/app_factory.py`, `src/trading_bot/runtime/startup.py` | Wire config, services, repositories, startup tasks, Flask app construction, and route blueprints. | Embed policy rules or direct broker/data access. |
