...
def classify_market_regime(
    *,
    ...
    breadth = _float(market_context.get("breadth_score") or market_context.get("market_breadth_score"))
    ...
    elif volume_state in {"thin", "low"} or (volume_surge_ratio is not None and volume_surge_ratio <= 0.55):
