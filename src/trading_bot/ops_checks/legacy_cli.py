...
The root ``ops_check.py`` shim delegates here. Full command help lives in
``README.md`` and ``ops/README.md``; this module owns dispatch only.
"""
...
_LAZY_HANDLER_REFS = {
    ...
    "run_active_learning_integration": "trading_bot.ops_checks.commands.active_learning_checks:run_active_learning_integration",
    "run_advanced_alpha_model_comparison": "trading_bot.ops_checks.commands.advanced_alpha_model_comparison_checks:run_advanced_alpha_model_comparison",
    "run_advanced_alpha_readiness": "trading_bot.ops_checks.commands.advanced_alpha_readiness_checks:run_advanced_alpha_readiness",
    "run_advisory_authority_report": "trading_bot.ops_checks.commands.advisory_authority_checks:run_advisory_authority_report",
    ...
    "run_buy_opportunity_report": "trading_bot.ops_checks.commands.conviction_checks:run_buy_opportunity_report",
    "run_claude_context_audit": "trading_bot.ops_checks.commands.conviction_checks:run_claude_context_audit",
    "run_conviction_persistence_health": "trading_bot.ops_checks.commands.conviction_checks:run_conviction_persistence_health",
    "run_conviction_stack_report": "trading_bot.ops_checks.commands.conviction_checks:run_conviction_stack_report",
    ...
    "run_event_source_coverage": "trading_bot.ops_checks.commands.event_source_checks:run_event_source_coverage",
    "run_peak_bucket_report": "trading_bot.ops_checks.commands.excursion_checks:run_peak_bucket_report",
    "run_winner_became_loser": "trading_bot.ops_checks.commands.excursion_checks:run_winner_became_loser",
    "run_exit_intelligence_summary": "trading_bot.ops_checks.commands.exit_intelligence_checks:run_exit_intelligence_summary",
    "run_exit_snapshot_backfill": "trading_bot.ops_checks.commands.exit_snapshot_backfill_checks:run_exit_snapshot_backfill",
    "run_external_observability_readiness_report": "trading_bot.ops_checks.commands.external_observability_readiness_checks:run_external_observability_readiness_report",
    "run_external_symbol_candidates": "trading_bot.ops_checks.commands.external_symbol_candidate_checks:run_external_symbol_candidates",
    "run_external_symbol_discovery": "trading_bot.ops_checks.commands.external_symbol_discovery_checks:run_external_symbol_discovery",
    "run_feature_attribution_report": "trading_bot.ops_checks.commands.feature_attribution_checks:run_feature_attribution_report",
    "run_feature_health": "trading_bot.ops_checks.commands.feature_checks:run_feature_health",
    "run_feature_watch": "trading_bot.ops_checks.commands.feature_checks:run_feature_watch",
    "run_feature_flag_change_history_report": "trading_bot.ops_checks.commands.feature_flag_change_history_checks:run_feature_flag_change_history_report",
    "run_feature_flag_inventory_report": "trading_bot.ops_checks.commands.feature_flag_inventory_checks:run_feature_flag_inventory_report",
    "run_friction_heatmap": "trading_bot.ops_checks.commands.friction_heatmap_checks:run_friction_heatmap",
    "run_full_session_paper_replay_report": "trading_bot.ops_checks.commands.full_session_paper_replay_checks:run_full_session_paper_replay_report",
    "run_historical_bar_archive": "trading_bot.ops_checks.commands.historical_bar_archive_checks:run_historical_bar_archive",
    "run_historical_bar_coverage": "trading_bot.ops_checks.commands.historical_bar_coverage_checks:run_historical_bar_coverage",
    "run_historical_bar_model_readiness": "trading_bot.ops_checks.commands.historical_bar_model_checks:run_historical_bar_model_readiness",
    "run_historical_bar_paper_strategy_report": "trading_bot.ops_checks.commands.historical_bar_paper_strategy_checks:run_historical_bar_paper_strategy_report",
    "run_historical_bar_paper_validation": "trading_bot.ops_checks.commands.historical_bar_paper_validation_checks:run_historical_bar_paper_validation",
    "run_historical_bar_walk_forward": "trading_bot.ops_checks.commands.historical_bar_paper_validation_checks:run_historical_bar_walk_forward",
    ...
    "run_learning_artifact_consumption": "trading_bot.ops_checks.commands.learning_artifact_checks:run_learning_artifact_consumption",
    "run_learning_effectiveness": "trading_bot.ops_checks.commands.learning_readiness_checks:run_learning_effectiveness",
    "run_learning_readiness": "trading_bot.ops_checks.commands.learning_readiness_checks:run_learning_readiness",
    ...
    "run_portfolio_risk_report": "trading_bot.ops_checks.commands.portfolio_risk_checks:run_portfolio_risk_report",
    "run_post_trade_learning_report": "trading_bot.ops_checks.commands.post_trade_learning_checks:run_post_trade_learning_report",
    "run_rejected_outcomes_health": "trading_bot.ops_checks.commands.rejected_outcome_checks:run_rejected_outcomes_health",
    "run_rejection_summary": "trading_bot.ops_checks.commands.rejection_checks:run_rejection_summary",
    "run_research_export": "trading_bot.ops_checks.commands.research_export_checks:run_research_export",
    "run_resource_readiness": "trading_bot.ops_checks.commands.resource_readiness_checks:run_resource_readiness",
    ...
    "run_trading_education_coverage": "trading_bot.ops_checks.commands.trading_education_checks:run_trading_education_coverage",
    "run_trading_education_health": "trading_bot.ops_checks.commands.trading_education_checks:run_trading_education_health",
    "run_trading_education_review": "trading_bot.ops_checks.commands.trading_education_checks:run_trading_education_review",
    "run_transformer_authority_report": "trading_bot.ops_checks.commands.transformer_authority_checks:run_transformer_authority_report",
    "run_volatile_session_intelligence_report": "trading_bot.ops_checks.commands.volatile_session_intelligence_checks:run_volatile_session_intelligence_report",
    "run_volume_clock_vpin_report": "trading_bot.ops_checks.commands.volume_clock_vpin_checks:run_volume_clock_vpin_report",
}

globals().update(
    {name: _lazy_handler(handler_ref) for name, handler_ref in _LAZY_HANDLER_REFS.items()}
)
