...
def _canonical_intelligence_state(canonical_intelligence: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "hash": data.get("feature_vector_hash") or data.get("canonical_intelligence_hash"),
...
def build_canonical_exit_snapshot(
    *,
    ...
    entry_canonical_intelligence_version: str | None = None,
    entry_canonical_intelligence_hash: str | None = None,
    ...
    exit_identity = {
        ...
        "entry_canonical_intelligence_version": entry_canonical_intelligence_version,
        "entry_canonical_intelligence_hash": entry_canonical_intelligence_hash,
    }
    trigger_state = {
