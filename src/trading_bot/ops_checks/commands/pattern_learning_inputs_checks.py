...
def run_pattern_learning_inputs_report(
    ...
    *,
    ...
    print(f"  matched_trades                    : {summary['matched_trades']}")
    print(
    ...
    print(
        f"  avg_long_opportunity_score        : {_fmt(bar_patterns['avg_long_opportunity_score'])}"
    )
    print(
        f"  avg_sell_opportunity_score        : {_fmt(bar_patterns['avg_sell_opportunity_score'])}"
    )
    print(f"  buy_window_win_rate               : {_fmt(bar_patterns.get('buy_window_win_rate'))}")
    print(
