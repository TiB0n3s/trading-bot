...
def run_portfolio_risk_report(target_date: str, *, base_dir: Path) -> bool:
    ...
    for row in buy_rows:
        ...
        metrics = {
            ...
            "incremental_var_pct": portfolio.get("incremental_var_pct") or regime.get("incremental_var_pct"),
            "beta_contribution_delta": portfolio.get("beta_contribution_delta") or regime.get("beta_contribution_delta"),
    ...
    print(f"  {'time':<19} {'sym':<6} {'approved':<8} {'decision':<10} {'dup':>7} {'var':>7} {'beta':>7} theme/overlap")
