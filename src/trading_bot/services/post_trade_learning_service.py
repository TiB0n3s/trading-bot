...
def build_post_trade_learning_payload(
    ...
    *,
    ...
    expectancy = {dimension: _expectancy_rows(rows_list, dimension) for dimension in dimensions}
    ...
    for item in gate_buckets.values():
        ...
        item["help_rate"] = (
            round(item["would_have_helped"] / len(outcomes), 4) if outcomes else None
        )
