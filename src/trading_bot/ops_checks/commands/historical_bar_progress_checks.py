...
DEFAULT_MANIFEST_DIR = Path("data") / "historical_bars" / "polygon_1min" / "backfill_manifests"
...
def run_historical_bar_progress(
    *,
    ...
    recent_errors = [err for manifest in manifests for err in (manifest.get("errors") or [])]
