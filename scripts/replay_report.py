...
def main() -> int:
    ...
    if not disagreements:
        ...
        print(
            f"  {'ID':>5} {'Time':<19} {'Sym':<6} {'Act':<5} {'Orig':<6} {'Replay':<6} {'Score':>6} {'Setup':<18} {'Posture':<18} Reason"
        )
        print(
            f"  {'-' * 5} {'-' * 19} {'-' * 6} {'-' * 5} {'-' * 6} {'-' * 6} {'-' * 6} {'-' * 18} {'-' * 18} {'-' * 30}"
        )
    ...
    print(
        f"  {'ID':>5} {'Time':<19} {'Sym':<6} {'Act':<5} {'Orig':<6} {'Replay':<6} {'Score':>6} {'Setup':<18} {'Posture':<18}"
    )
    print(
        f"  {'-' * 5} {'-' * 19} {'-' * 6} {'-' * 5} {'-' * 6} {'-' * 6} {'-' * 6} {'-' * 18} {'-' * 18}"
    )
