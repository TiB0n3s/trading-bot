...
def main():
    ...
    trend_conf = [
        r for r in rejected if (r["rejection_reason"] or "").startswith("trend_confirmation:")
    ]
    ...
    churn_price = [r for r in rejected if (r["rejection_reason"] or "").startswith("churn_price:")]
