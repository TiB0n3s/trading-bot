    ...
    with sqlite3.connect(f"file:{path}?mode=ro", uri=True) as con:
        ...
        rows = con.execute(
            ...
            SELECT
                ...
                {bp_expr("volume_profile_bin_00")},
                {bp_expr("volume_profile_bin_01")},
                {bp_expr("volume_profile_bin_02")},
                {bp_expr("volume_profile_bin_03")},
                {bp_expr("volume_profile_bin_04")},
                {bp_expr("volume_profile_bin_05")},
                {bp_expr("volume_profile_bin_06")},
                {bp_expr("volume_profile_bin_07")},
                {bp_expr("volume_profile_bin_08")},
                {bp_expr("volume_profile_bin_09")},
                {bp_expr("volume_profile_bin_10")},
                {bp_expr("volume_profile_bin_11")},
                {bp_expr("volume_profile_bin_12")},
                {bp_expr("volume_profile_bin_13")},
                {bp_expr("volume_profile_bin_14")},
                {bp_expr("volume_profile_bin_15")},
                {bp_expr("volume_profile_bin_16")},
                {bp_expr("volume_profile_bin_17")},
                {bp_expr("volume_profile_bin_18")},
                {bp_expr("volume_profile_bin_19")},
