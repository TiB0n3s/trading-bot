...
class BarPatternFeatureRepository:
        ...
        with get_connection(self.db_path) as con:
            con.execute(
                ...
                CREATE TABLE IF NOT EXISTS bar_pattern_features (
                    ...
                    volume_profile_poc_dist_pct REAL,
                    volume_profile_vah_dist_pct REAL,
                    volume_profile_val_dist_pct REAL,
                    volume_profile_hvn_dist_pct REAL,
                    volume_profile_lvn_dist_pct REAL,
                    volume_profile_poc_volume_zscore REAL,
                    volume_profile_total_volume_zscore REAL,
                    volume_profile_value_area_width_pct REAL,
                    volume_profile_close_position REAL,
                    volume_profile_low_volume_zone INTEGER,
                    volume_profile_bin_00 REAL,
                    volume_profile_bin_01 REAL,
                    volume_profile_bin_02 REAL,
                    volume_profile_bin_03 REAL,
                    volume_profile_bin_04 REAL,
                    volume_profile_bin_05 REAL,
                    volume_profile_bin_06 REAL,
                    volume_profile_bin_07 REAL,
                    volume_profile_bin_08 REAL,
                    volume_profile_bin_09 REAL,
                    volume_profile_bin_10 REAL,
                    volume_profile_bin_11 REAL,
                    volume_profile_bin_12 REAL,
                    volume_profile_bin_13 REAL,
                    volume_profile_bin_14 REAL,
                    volume_profile_bin_15 REAL,
                    volume_profile_bin_16 REAL,
                    volume_profile_bin_17 REAL,
                    volume_profile_bin_18 REAL,
                    volume_profile_bin_19 REAL,
            ...
            for column in VOLUME_PROFILE_COLUMNS:
                column_type = "INTEGER" if column == "volume_profile_low_volume_zone" else "REAL"
                self._ensure_column(con, column, column_type)
        ...
        with get_connection(self.db_path) as con:
            con.executemany(
                ...
                INSERT INTO bar_pattern_features (
                    ...
                    atr_20_pct, volume_ratio_20,
                    volume_profile_poc_dist_pct, volume_profile_vah_dist_pct,
                    volume_profile_val_dist_pct, volume_profile_hvn_dist_pct,
                    volume_profile_lvn_dist_pct, volume_profile_poc_volume_zscore,
                    volume_profile_total_volume_zscore,
                    volume_profile_value_area_width_pct,
                    volume_profile_close_position, volume_profile_low_volume_zone,
                    volume_profile_bin_00, volume_profile_bin_01,
                    volume_profile_bin_02, volume_profile_bin_03,
                    volume_profile_bin_04, volume_profile_bin_05,
                    volume_profile_bin_06, volume_profile_bin_07,
                    volume_profile_bin_08, volume_profile_bin_09,
                    volume_profile_bin_10, volume_profile_bin_11,
                    volume_profile_bin_12, volume_profile_bin_13,
                    volume_profile_bin_14, volume_profile_bin_15,
                    volume_profile_bin_16, volume_profile_bin_17,
                    volume_profile_bin_18, volume_profile_bin_19,
                    pressure_return_3,
                ...
                DO UPDATE SET
                    ...
                    volume_profile_poc_dist_pct = excluded.volume_profile_poc_dist_pct,
                    volume_profile_vah_dist_pct = excluded.volume_profile_vah_dist_pct,
                    volume_profile_val_dist_pct = excluded.volume_profile_val_dist_pct,
                    volume_profile_hvn_dist_pct = excluded.volume_profile_hvn_dist_pct,
                    volume_profile_lvn_dist_pct = excluded.volume_profile_lvn_dist_pct,
                    volume_profile_poc_volume_zscore = excluded.volume_profile_poc_volume_zscore,
                    volume_profile_total_volume_zscore = excluded.volume_profile_total_volume_zscore,
                    volume_profile_value_area_width_pct = excluded.volume_profile_value_area_width_pct,
                    volume_profile_close_position = excluded.volume_profile_close_position,
                    volume_profile_low_volume_zone = excluded.volume_profile_low_volume_zone,
                    volume_profile_bin_00 = excluded.volume_profile_bin_00,
                    volume_profile_bin_01 = excluded.volume_profile_bin_01,
                    volume_profile_bin_02 = excluded.volume_profile_bin_02,
                    volume_profile_bin_03 = excluded.volume_profile_bin_03,
                    volume_profile_bin_04 = excluded.volume_profile_bin_04,
                    volume_profile_bin_05 = excluded.volume_profile_bin_05,
                    volume_profile_bin_06 = excluded.volume_profile_bin_06,
                    volume_profile_bin_07 = excluded.volume_profile_bin_07,
                    volume_profile_bin_08 = excluded.volume_profile_bin_08,
                    volume_profile_bin_09 = excluded.volume_profile_bin_09,
                    volume_profile_bin_10 = excluded.volume_profile_bin_10,
                    volume_profile_bin_11 = excluded.volume_profile_bin_11,
                    volume_profile_bin_12 = excluded.volume_profile_bin_12,
                    volume_profile_bin_13 = excluded.volume_profile_bin_13,
                    volume_profile_bin_14 = excluded.volume_profile_bin_14,
                    volume_profile_bin_15 = excluded.volume_profile_bin_15,
                    volume_profile_bin_16 = excluded.volume_profile_bin_16,
                    volume_profile_bin_17 = excluded.volume_profile_bin_17,
                    volume_profile_bin_18 = excluded.volume_profile_bin_18,
                    volume_profile_bin_19 = excluded.volume_profile_bin_19,
    ...
    def summary(self, target_date: str, symbol: str | None = None) -> dict[str, Any]:
        ...
        with get_connection(self.db_path) as con:
            row = con.execute(
                ...
                SELECT
                    ...
                    SUM(CASE WHEN volume_profile_poc_dist_pct IS NOT NULL THEN 1 ELSE 0 END)
                        AS rows_with_volume_profile,
        ...
        return {
            ...
            "rows_with_volume_profile": int(row["rows_with_volume_profile"] or 0),
