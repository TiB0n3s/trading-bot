...
def build_setup_observation(
    ...
    try:
        ...
        setup_quality["structure_expectancy_modifier"] = structure.get("expectancy_modifier")
        ...
        if setup_quality_source != "setup_engine":
            deps.log.warning(f"setup_quality fallback for {symbol}: source={setup_quality_source}")
