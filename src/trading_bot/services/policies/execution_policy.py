...
def try_portfolio_rotation(
    *,
    ...
    if score < min_candidate_score:
        return (
            False,
            f"candidate score {score} < {min_candidate_score}: {score_reason}",
            {
    ...
    if not weakest:
        return (
            False,
            "no eligible weak holding found",
            {
                "candidate_score": score,
                "candidate_score_reason": score_reason,
            },
    ...
    if not order_result:
        return (
            False,
            f"rotation sell failed for {sell_symbol}",
            {
                "candidate_score": score,
                "candidate_score_reason": score_reason,
                "weakest": weakest,
    ...
    return (
        True,
        f"submitted rotation sell for {sell_symbol}",
        {
            "candidate_score": score,
            "candidate_score_reason": score_reason,
            "weakest": weakest,
