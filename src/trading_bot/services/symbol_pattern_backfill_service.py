...
def canonical_symbol_pattern_state(canonical: dict[str, Any]) -> dict[str, Any]:
    ...
    if pattern.get("pattern_label"):
        return {
            **pattern,
            ...
            "runtime_effect": pattern.get("runtime_effect") or "observe_only_no_live_authority",
            "source": pattern.get("source") or "canonical_pattern_state",
        }

    analytics_pattern = _dict(_dict(canonical.get("analytics_state")).get("ai_momentum_pattern"))
    if analytics_pattern.get("pattern_label"):
        ...
        return {
            ...
            "favorable_move_probability": analytics_pattern.get("favorable_move_probability"),
            ...
            "historical_sample_size": analytics_pattern.get("historical_sample_size"),
    ...
    return {
        ...
        "runtime_effect": derived.get("runtime_effect") or "observe_only_no_live_authority",
        ...
        "historical_sample_size": _dict(derived.get("historical_bucket")).get("sample_size"),
