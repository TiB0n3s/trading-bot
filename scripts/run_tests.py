...
TESTS = [
    ...
    "tests/test_conviction_policy.py",
    "tests/test_auto_buy_manager.py",
    "tests/test_auto_buy_repo.py",
    "tests/test_discovery_execution_bridge.py",
    ...
    "tests/test_premarket_context_collectors.py",
    ...
    "tests/test_value_chain_eco_cluster_service.py",
    ...
    "tests/test_historical_bar_walk_forward_validation.py",
    ...
    "tests/test_bar_timing_quality_service.py",
