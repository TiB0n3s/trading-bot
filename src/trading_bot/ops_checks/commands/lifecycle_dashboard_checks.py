...
def run_lifecycle_dashboard(
    ...
    *,
    ...
    print(f"approved_open_or_unlinked_exit: {summary['approved_open_or_unlinked_exit']}")
    ...
    print()
    print(
        "[OK] lifecycle dashboard is analysis-ready"
        if ok
        else "[WARN] lifecycle dashboard has coverage gaps"
    )
    return ok
