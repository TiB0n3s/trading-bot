...
class SessionMomentumService:
    ...
    def build_from_bars(self, symbol: str, bars: list[Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "momentum_60m_pct": round(momentum_60m, 3) if momentum_60m is not None else None,
            "momentum_120m_pct": round(momentum_120m, 3) if momentum_120m is not None else None,
