...
from strategy_constants import ADAPTIVE_BUY_CONFIRMATION_ENABLED, APPROVED_SYMBOLS
...
def main():
    ...
    for sym in sorted(APPROVED_SYMBOLS):
        ...
        adaptive = _required_buy_confirmations(
            sym,
            {
    ...
    if ADAPTIVE_BUY_CONFIRMATION_ENABLED:
        ...
        print(
            "Observe-only: adaptive BUY confirmation is not active until the env flag is enabled."
        )
