...
def _print_human(payload: dict) -> None:
    ...
    print(f"coverage_status          : {payload.get('coverage_status')}")
    print(f"latest_available_date    : {payload.get('latest_available_date')}")
    print(f"missing_requested_sessions: {payload.get('missing_requested_session_count')}")
